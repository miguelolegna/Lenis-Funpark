    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-surface">
      ...
      <header className="md:hidden flex items-center justify-between p-4 bg-white border-b-2 border-surface-alt sticky top-0 z-50">
        ...
        <div className="flex items-center gap-2">
          <NavLink
            to="/"
            className="p-2 rounded-xl text-secondary/70 hover:text-primary hover:bg-surface-alt transition-colors flex items-center gap-1 text-xs font-bold"
      ...
      >
        ...
        {/* Footer da Sidebar: Utilizador, Voltar ao Site e Logout */}
        <div className="p-4 border-t border-surface-alt bg-surface/50 space-y-2">
          <div className="px-2">
          ...
          <NavLink
            to="/"
            className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-white border-2 border-surface-alt text-secondary font-bold text-sm rounded-xl hover:bg-primary/10 hover:border-primary/30 hover:text-primary transition-colors"
          >
