-- ==============================================================================
-- Migração 53: Adicionar base de cobertura para bolos com imagem
-- ==============================================================================

-- 1. Adicionar nova coluna
ALTER TABLE reservas
ADD COLUMN IF NOT EXISTS bolo_cobertura_base TEXT;

-- 2. Atualizar a RPC atualizar_reserva_b2c para aceitar e persistir o novo campo
...
BEGIN
    ...
    IF p_payload ? 'bolo_cobertura_base' THEN UPDATE reservas SET bolo_cobertura_base = p_payload->>'bolo_cobertura_base' WHERE id = v_reserva_id; END IF;
