ALTER TABLE reservas ADD COLUMN IF NOT EXISTS tema_personalizado TEXT;

-- Atualizar RPC de atualização para permitir a escrita da nova coluna
...
-- Recompilar RPC de obtenção para forçar a inclusão do novo schema no to_jsonb(r)
...
-- Notificar PostgREST para recarregar a cache
